...
class TestComponentFileWatcher:
    """Test cases for ComponentFileWatcher."""
    ...
    def test_start_file_watching_disabled_in_production(
        self, mock_dev_mode, file_watcher
    ):
    ...
    @patch("streamlit.components.v2.component_file_watcher._get_is_development_mode")
    def test_start_file_watching_no_watchers(self, mock_dev_mode, file_watcher):
    ...
    def test_start_file_watching_mixed_patterns(
        self, mock_path_watcher_class, mock_dev_mode, file_watcher, temp_component_files
    ):
    ...
    def test_stop_file_watching(self, file_watcher):
    ...
    def test_stop_file_watching_with_close_errors(self, file_watcher):
    ...
    def test_on_directory_changed(
        self, mock_dev_mode, file_watcher, temp_component_files, mock_component_manifest
    ):
        ...
        with patch.object(
            file_watcher, "_re_resolve_component_patterns"
        ) as mock_resolve:
    ...
    def test_re_resolve_component_patterns_direct_file_path(
        self, file_watcher, temp_component_files, mock_component_manifest
    ):
    ...
    def test_re_resolve_component_patterns_glob_patterns(
        self, file_watcher, temp_component_files, mock_glob_component_manifest
    ):
        ...
        assert (
            result["css"].resolve() == temp_component_files["glob_css_file"].resolve()
        )
    ...
    @patch("streamlit.components.v2.component_file_watcher._get_is_development_mode")
    def test_change_events_ignored_when_not_watching(self, mock_dev_mode, file_watcher):
    ...
    @patch("streamlit.components.v2.component_file_watcher._get_is_development_mode")
    def test_change_events_ignored_when_not_in_dev_mode(
        self, mock_dev_mode, file_watcher
    ):

...
def test_trigger_interactions(app: Page):
    ...
    expect(app.get_by_text("Session state: {'value': {}}")).to_be_visible()
    ...
    expect(app.get_by_text("Session state: {'value': {'foo': True}}")).to_be_visible()
    ...
    expect(app.get_by_text("Session state: {'value': {'bar': True}}")).to_be_visible()
    ...
    expect(
        app.get_by_text("Session state: {'value': {'foo': True, 'bar': True}}")
    ).to_be_visible()
